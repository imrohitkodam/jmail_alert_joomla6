		...
		<div class="row-fluid">
			<div class="span8">
				<div class="control-group">
					<label class="control-label" for="alert_list" title="<?php echo Text::_('COM_JMAILALERTS_ALERT_TITLE_TOOLTIP'); ?>">
					...
					<div class="controls">
						...
						echo $this->dropdown = HTMLHelper::_(
							...
							'required="required" aria-invalid="false" size="1" onchange="loadFrequencies(id)"',
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						echo $this->dropdown = HTMLHelper::_(
							...
							'required="required" aria-invalid="false" size="1"',
				...
				<div class="control-group">
					<label class="control-label" for="advaced_options" title="<?php echo Text::_('COM_JMAILALERTS_ADVANCE_OPTION_TOOLTIP'); ?>">
				...
				<div class="control-group advanceoption">
					<label class="control-label" for="freq_id" title="<?php echo Text::_('COM_JMAILALERTS_FREQ_TOOLTIP'); ?>">
				...
				<div class="control-group advanceoption">
					...
					<div class="controls">
						...
						echo $calendar = HTMLHelper::_('calendar', $date, 'last_email_date', 'last_email_date',
				...
				<div class="control-group advanceoption">
					<label class="control-label" for="batch_size" title="<?php echo Text::_('COM_JMAILALERTS_BATCH_SIZE_TOOLTIP'); ?>">
				...
				<div class="control-group advanceoption">
					<label class="control-label" for="user_pref" title="<?php echo Text::_('COM_JMAILALERTS_OVERWRITE_USER_PREF_TOOLTIP'); ?>">
						<?php echo Text::_('COM_JMAILALERTS_OVERWRITE_USER_PREF'); ?>
					</label>
					<div class="controls ">
						<label class="radio inline">
							<input type="radio" class="btn-group" name="user_pref" id="user_pref1" value="1" onclick="ShowHideReaddUnsubsUser()"/>
							<?php echo Text::_('COM_JMAILALERTS_YES'); ?>
						</label>
						<label class="radio inline">
							<input type="radio" class="btn-group" name="user_pref" id="user_pref2" value="0" checked="checked" onclick="ShowHideReaddUnsubsUser()"/>
				...
				<div class="control-group advanceoption ShowHideReaddUnsubsUserCls">
					<label class="control-label" for="unsub_user" title="<?php echo Text::_('COM_JMAILALERTS_ADD_UNSUB_USERS_TOOLTIP'); ?>">
						<?php echo Text::_('COM_JMAILALERTS_ADD_UNSUB_USERS'); ?>
					</label>
					<div class="controls">
						<label class="radio inline">
							<input type="radio" name="unsub_user" id="unsub_user1" value="1" onclick="chaneSubsreport()"/><?php echo Text::_('COM_JMAILALERTS_YES'); ?>
						</label>
						<label class="radio inline">
							<input type="radio" name="unsub_user" id="unsub_user2" value="0"   onclick="chaneSubsreport()" checked="checked" />
								<?php echo Text::_('COM_JMAILALERTS_NO'); ?>
						</label>
					</div>
				</div>
			...
			<div class="span4">
				<h5><?php echo Text::_('COM_JMAILALERTS_SYNC_NOTE'); ?></h5>
				<div class="alert alert-info">
					<h5><?php echo Text::_('COM_JMAILALERTS_SYNC_SYNC_NEW_USERS'); ?></h5>
					<ul>
						<li><?php echo Text::_('COM_JMAILALERTS_SYNC_SYNC_NEW_USERS_DESC'); ?></li>
					</ul>
					<h5><?php echo Text::_('COM_JMAILALERTS_SYNC_SYNC_OVERWRITE'); ?></h5>
					<ol>
